...
<html>
<head>
<title>SokoEffect :: Profile</title>
...
<script>
		...
		<link rel="stylesheet" type="text/css" href="<?php echo base_url().'vendor/css/easy-responsive-tabs.css '?>" />
    <script src="<?php echo base_url().'vendor/js/easyResponsiveTabs.js'?>"></script>
</head>
<body>